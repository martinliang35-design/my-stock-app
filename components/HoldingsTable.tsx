              ...
              >
                  ...
                  <>
                    ...
                    <td className="px-3 py-2.5 text-right">
                      <input
                        ...
                        step={0.01}
                        min={0}
                        defaultValue={h.cost_price}
                        onBlur={(e) => {
                          const v = Number(e.target.value);
                          if (Number.isFinite(v) && v >= 0 && v !== h.cost_price) onUpdate(h.id, { cost_price: v });
                        }}
                        className="w-20 rounded border border-slate-600 bg-slate-800 px-2 py-1 text-right text-slate-100 focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
                      />
                    </td>
                ...
                <td className="px-3 py-2.5 text-right">
                  <input
                    ...
                    onBlur={(e) => {
                      const v = Number(e.target.value);
                      if (Number.isFinite(v) && v >= 0 && v !== h.current_price) onUpdate(h.id, { current_price: v });
                    }}
                    className="w-20 rounded border border-slate-600 bg-slate-800 px-2 py-1 text-right text-slate-100 focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
                  />
                </td>
